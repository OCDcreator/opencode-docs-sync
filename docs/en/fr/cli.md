...
| ---------------------------------------- | ----- | ----------------------------------------------------------------------------- |
|  | `-c`  | Continuer la dernière session                                                 |
|   | `-s`  | ID de session pour continuer                                                  |
|      |       | Forker la session en continuant (à utiliser avec `--continue` ou `--session`) |
|    |       | Prompt à utiliser                                                             |
|     | `-m`  | Modèle à utiliser sous forme de fournisseur/modèle                            |
|     |       | Agent à utiliser                                                              |
|      |       | Port d'écoute                                                                 |
|  |       | Nom d'hôte d'écoute                                                           |
...
| Option                                   | Court | Description                                                                                        |
| ---------------------------------------- | ----- | -------------------------------------------------------------------------------------------------- |
|       |       | Répertoire de travail dans lequel démarrer TUI                                                     |
|  | `-c`  | Continuer la dernière session                                                                      |
|   | `-s`  | ID de session pour continuer                                                                       |
|      |       | Dupliquer la session lors de la reprise (à utiliser avec `--continue` ou `--session`)              |
|  | `-p`  | Mot de passe d'authentification de base (par défaut `OPENCODE_SERVER_PASSWORD`)                    |
|  | `-u`  | Nom d'utilisateur d'authentification de base (par défaut `OPENCODE_SERVER_USERNAME` ou `opencode`) |
...
| Option                                | Description                                          |
| ------------------------------------- | ---------------------------------------------------- |
|  | Événement simulé GitHub pour lequel exécuter l'agent |
...
| Option                                  | Description                                                                                |
| --------------------------------------- | ------------------------------------------------------------------------------------------ |
|  | Actualisez le cache des modèles à partir de models.dev                                     |
|  | Utiliser une sortie de modèle plus détaillée (inclut des métadonnées telles que les coûts) |
...
| Option                                   | Court | Description                                                                                        |
| ---------------------------------------- | ----- | -------------------------------------------------------------------------------------------------- |
|   |       | La commande à exécuter, utilisez le message pour les arguments                                     |
|  | `-c`  | Continuer la dernière session                                                                      |
|   | `-s`  | ID de session pour continuer                                                                       |
|      |       | Forker la session en continuant (à utiliser avec `--continue` ou `--session`)                      |
|     |       | Partager la session                                                                                |
|     | `-m`  | Modèle à utiliser sous forme de fournisseur/modèle                                                 |
|     |       | Agent à utiliser                                                                                   |
|      | `-f`  | Fichier(s) à joindre au message                                                                    |
|    |       | Format : par défaut (formaté) ou json (événements JSON bruts)                                      |
|     |       | Titre de la session (utilise un prompt tronqué si aucune valeur n'est fournie)                     |
|    |       | Connectez-vous à un serveur opencode en cours d'exécution (par exemple, http://localhost:4096)     |
|  | `-p`  | Mot de passe d'authentification de base (par défaut `OPENCODE_SERVER_PASSWORD`)                    |
|  | `-u`  | Nom d'utilisateur d'authentification de base (par défaut `OPENCODE_SERVER_USERNAME` ou `opencode`) |
|       |       | Répertoire d'exécution, ou chemin sur le serveur distant lors de l'attachement                     |
|   |       | Variante du modèle (effort de raisonnement spécifique au fournisseur)                              |
|  |       | Afficher les blocs de réflexion                                                                    |
|      |       | Port du serveur local (port aléatoire par défaut)                                                  |
...
|      | Port d'écoute                                              |
|  | Nom d'hôte d'écoute                                        |
|      | Activer la découverte mDNS                                 |
|      | Origines de navigateur supplémentaires pour autoriser CORS |
...
| Option                                    | Court | Description                                  |
| ----------------------------------------- | ----- | -------------------------------------------- |
|  | `-n`  | Limiter aux N sessions les plus récentes     |
|     |       | Format de sortie : tableau ou json (tableau) |
...
| Option                                  | Description                                                                                                           |
| --------------------------------------- | --------------------------------------------------------------------------------------------------------------------- |
|     | Afficher les statistiques des N derniers jours (depuis le début)                                                      |
|    | Nombre d'outils à afficher (tous)                                                                                     |
|   | Afficher la répartition de l'utilisation du modèle (masqué par défaut). Passez un numéro pour afficher les N premiers |
|  | Filtrer par projet (tous les projets, chaîne vide : projet actuel)                                                    |
...
| Option                                      | Court | Description                                         |
| ------------------------------------------- | ----- | --------------------------------------------------- |
|  | `-c`  | Conserver les fichiers de configuration             |
|    | `-d`  | Conserver les données de session et les instantanés |
|      |       | Afficher ce qui serait supprimé sans supprimer      |
|        | `-f`  | Ignorer les invites de confirmation                 |
...
| Option                                 | Court | Description                                                     |
| -------------------------------------- | ----- | --------------------------------------------------------------- |
|  | `-m`  | La méthode d'installation utilisée ; curl, npm, pnpm, bun, brew |
