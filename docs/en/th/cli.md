...
| แฟล็ก                                    | สั้น | คำอธิบาย                                                   |
| ---------------------------------------- | ---- | ---------------------------------------------------------- |
|  | `-c` | ดำเนินการต่อจากเซสชันล่าสุด                                |
|   | `-s` | ID เซสชันเพื่อดำเนินการต่อ                                 |
|      |      | แยกเซสชันเมื่อทำต่อ (ใช้กับ `--continue` หรือ `--session`) |
|    |      | พรอมต์เริ่มต้นที่จะใช้                                     |
|     | `-m` | โมเดลที่จะใช้ในรูปแบบ provider/model                       |
|     |      | เอเจนต์ที่จะใช้                                            |
|      |      | พอร์ตที่จะฟัง                                              |
|  |      | ชื่อโฮสต์ที่จะฟัง                                          |
...
|  | `-p` | รหัสผ่านการยืนยันตัวตนพื้นฐาน (ค่าเริ่มต้นคือ `OPENCODE_SERVER_PASSWORD`)                   |
|  | `-u` | ชื่อผู้ใช้การยืนยันตัวตนพื้นฐาน (ค่าเริ่มต้นคือ `OPENCODE_SERVER_USERNAME` หรือ `opencode`) |
...
| แฟล็ก                                     | สั้น | คำอธิบาย                      |
| ----------------------------------------- | ---- | ----------------------------- |
|  | `-n` | จำกัดการแสดงผล N รายการล่าสุด |
...
| แฟล็ก                                       | สั้น | คำอธิบาย                            |
| ------------------------------------------- | ---- | ----------------------------------- |
|  | `-c` | เก็บไฟล์การกำหนดค่าไว้              |
|    | `-d` | เก็บไฟล์ข้อมูล (เซสชันและสแน็ปช็อต) |
|      |      | แสดงสิ่งที่จะลบออกโดยไม่ต้องทำจริง  |
|        | `-f` | บังคับลบโดยไม่มีการแจ้งเตือน        |
...
| แฟล็ก                                  | สั้น | คำอธิบาย                                        |
| -------------------------------------- | ---- | ----------------------------------------------- |
|  | `-m` | วิธีการติดตั้งที่ใช้ curl, npm, pnpm, bun, brew |
