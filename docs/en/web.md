...
![OpenCode Web - New Session](https://raw.githubusercontent.com/anomalyco/opencode/dev/packages/web/src/assets/web/web-homepage-new-session.png)
...
![OpenCode Web - Active Session](https://raw.githubusercontent.com/anomalyco/opencode/dev/packages/web/src/assets/web/web-homepage-active-session.png)

### Server Status

Click "See Servers" to view connected servers and their status.

![OpenCode Web - See Servers](https://raw.githubusercontent.com/anomalyco/opencode/dev/packages/web/src/assets/web/web-homepage-see-servers.png)
