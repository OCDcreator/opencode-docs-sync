...
| ---------------------------------------- | ---- | ------------------------------------------------------------------------ |
|  | `-c` | Fortsett siste økt                                                       |
|   | `-s` | Økt ID for å fortsette                                                   |
|      |      | Forgren økten ved fortsettelse (bruk med `--continue` eller `--session`) |
|    |      | Ledetekst som skal brukes                                                |
|     | `-m` | Modell å bruke i form av leverandør/modell                               |
|     |      | Agent som skal brukes                                                    |
|      |      | Port å lytte på                                                          |
|  |      | Vertsnavn å lytte på                                                     |
...
| Flagg                                    | Kort | Beskrivelse                                                                                        |
| ---------------------------------------- | ---- | -------------------------------------------------------------------------------------------------- |
|       |      | Arbeidskatalog for å starte TUI i                                                                  |
|  | `-c` | Fortsett siste økt                                                                                 |
|   | `-s` | Økt ID for å fortsette                                                                             |
|      |      | Forgren økten ved fortsettelse (bruk med `--continue` eller `--session`)                           |
|  | `-p` | Passord for grunnleggende autentisering (standard: `OPENCODE_SERVER_PASSWORD`)                     |
|  | `-u` | Brukernavn for grunnleggende autentisering (standard: `OPENCODE_SERVER_USERNAME` eller `opencode`) |
...
| Flagg                                 | Beskrivelse                                  |
| ------------------------------------- | -------------------------------------------- |
|  | GitHub mock-hendelse agenten skal kjøres for |
|  | GitHub personlig tilgangsnøkkel              |
...
| Flagg                                   | Beskrivelse                                                         |
| --------------------------------------- | ------------------------------------------------------------------- |
|  | Oppdater modellbufferen fra models.dev                              |
|  | Bruk mer detaljert modellutdata (inkluderer metadata som kostnader) |
...
| Flagg                                    | Kort | Beskrivelse                                                                                        |
| ---------------------------------------- | ---- | -------------------------------------------------------------------------------------------------- |
|   |      | Kommandoen for å kjøre, bruk melding for args                                                      |
|  | `-c` | Fortsett siste økt                                                                                 |
|   | `-s` | Økt ID for å fortsette                                                                             |
|      |      | Forgren økten ved fortsettelse (bruk med `--continue` eller `--session`)                           |
|     |      | Del økten                                                                                          |
|     | `-m` | Modell å bruke i form av leverandør/modell                                                         |
|     |      | Agent å bruke                                                                                      |
|      | `-f` | Fil(er) som skal legges ved meldingen                                                              |
|    |      | Format: standard (formatert) eller json (rå JSON hendelser)                                        |
|     |      | Tittel for økten (bruker avkortet ledetekst hvis ingen verdi er oppgitt)                           |
|    |      | Koble til en kjørende OpenCode-server (f.eks. http://localhost:4096)                               |
|  | `-p` | Passord for grunnleggende autentisering (standard: `OPENCODE_SERVER_PASSWORD`)                     |
|  | `-u` | Brukernavn for grunnleggende autentisering (standard: `OPENCODE_SERVER_USERNAME` eller `opencode`) |
|       |      | Katalog å kjøre i, eller sti på fjernserveren ved tilkobling                                       |
|   |      | Modellvariant (leverandørspesifikk resonneringsinnsats)                                            |
|  |      | Vis tenkeblokker                                                                                   |
|      |      | Port for den lokale serveren (standard til tilfeldig port)                                         |
...
|      | Port å lytte på                                    |
|  | Vertsnavn å lytte på                               |
|      | Aktiver mDNS-oppdagelse                            |
|      | Ytterligere nettleseropprinnelse som tillater CORS |
...
| Flagg                                     | Kort | Beskrivelse                              |
| ----------------------------------------- | ---- | ---------------------------------------- |
|  | `-n` | Begrens til N siste økter                |
|     |      | Utdataformat: tabell eller json (tabell) |
...
| Flagg                                   | Beskrivelse                                                                      |
| --------------------------------------- | -------------------------------------------------------------------------------- |
|     | Vis statistikk for de siste N dagene (hele tiden)                                |
|    | Antall verktøy som skal vises (alle)                                             |
|   | Vis oversikt over modellbruk (skjult som standard). Gi et tall for å vise topp N |
|  | Filtrer etter prosjekt (alle prosjekter, tom streng: gjeldende prosjekt)         |
...
| Flagg                                       | Kort | Beskrivelse                                   |
| ------------------------------------------- | ---- | --------------------------------------------- |
|  | `-c` | Behold konfigurasjonsfiler                    |
|    | `-d` | Behold øktdata og øyeblikksbilder             |
|      |      | Vis hva som ville blitt fjernet uten å fjerne |
|        | `-f` | Hopp over bekreftelsesforespørsler            |
...
| Flagg                                  | Kort | Beskrivelse                                                    |
| -------------------------------------- | ---- | -------------------------------------------------------------- |
|  | `-m` | Installasjonsmetoden som ble brukt: curl, npm, pnpm, bun, brew |
...
| ------------------------------------------ | ---- | ----------------------------------- |
|        | `-h` | Vis hjelp                           |
|     | `-v` | Skriv ut versjonsnummer             |
|  |      | Skriv ut logger til stderr          |
|   |      | Loggnivå (DEBUG, INFO, WARN, ERROR) |
